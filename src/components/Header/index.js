        ...
        <div>
            <header className="text-gray-600 body-font shadow-lg">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <button className="inline-flex items-center text-white bg-blue-500 border-0 py-2 px-4 ml-4 focus:outline-none hover:bg-blue-700 rounded text-base mt-4 md:mt-0" onClick={handleLogin}>Login
